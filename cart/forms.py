...
class AddToCartForm(forms.ModelForm):
    colour = forms.ModelChoiceField(queryset=ColourVariation.objects.all(), widget=forms.RadioSelect)
    size = forms.ModelChoiceField(queryset=SizeVariation.objects.all(), widget=forms.RadioSelect)
    ...
    def __init__(self, *args, **kwargs):
        ...
        print(product.available_colours.all())
